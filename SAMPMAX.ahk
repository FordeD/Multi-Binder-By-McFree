...
; # 														                                                                    #
; # SAMP-Funktionen:                                                                                                            #
; #     - IsSAMPAvailable()                         PrГјft, ob man in den Chat schreiben kann & ob GTA geladen ist               #
; #     - isInChat()                                PrГјft, ob der Spieler gerade chattet oder in einem Dialog ist               #
...
; #     - addChatMessage(wText)                     FГјgt eine Zeile in den Chat ein (nur fГјr den Spieler sichtbar)              #
...
; #     - getStreamedInPlayersInfo()                Zeigt Informationen Гјber die gestreamten Spieler.                           #
; #     - callFuncForAllStreamedInPlayers()         FГјhrt bestimmte Funktionen, fГјr die gestreamten Spieler aus.                #
...
; #     - getPlayerArmour()                         Ermittelt den RГјstungswert des Spielers                                     #
...
; #	    - getPlayerState()			                Ermittelt den "Status" des Spielers (Zu FuГџ, Fahrer, Tot)                   #
...
; #	    - getPlayerPos(X,Y,Z) 			            siehe oben drГјber 						                                    #
; # 														                                                                    #
; # --------------------------------------------------------------------------------------------------------------------------- #
; # 														                                                                    #
; #     - initZonesAndCities()                      Initialisiert eine Liste aller Standartgebiete                              #
; #                                                 (Voraussetzung fГјr die folgenden Funktionen dieser Kategorie)               #
...
; #     - AddZone(Name, X1, Y1, Z1, X2, Y2, Z2)     FГјgt eine Zone zum Index hinzu                                              #
; #     - AddCity(Name, X1, Y1, Z1, X2, Y2, Z2)     FГјgt eine Stadt zum Index hinzu                                             #
; #	    - IsPlayerInRangeOfPoint(X, Y, Z, Radius)   Bestimmt ob der Spieler in der NГ¤he der Koordinaten ist                     #
; #	    - IsIsPlayerInRangeOfPoint2D(X, Y, Radius)  Bestimmt ob der Spieler in der NГ¤he der Koordinaten ist                     #
; #	    - getPlayerZone()                   				                                                                    #
; #	    - getPlayerCity()                   					                                                                #
; # 														                                                                    #
; ###############################################################################################################################
